...
def main():
    ...
    if var_str!='x_num_cell':
        x_num_cell = float(lns[7].split()[-1])
    ...
    x_modNum = 2.0*pl.pi*x_num_cell
    y_modNum = 2.0*pl.pi*y_num_cell
    totTime = totIter*dt
    print("dt is: " + str(dt))
    ...
    apx = ec.SinSin2D(qq,As,beta,x_num_cell,y_num_cell,x_periodic,order)
