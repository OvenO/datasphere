...
def main():
    ...
    #        continue
    # this is just to see how out code is doing. give one particle a non zero velocity and see what
    # happens
    x0[0]=1.0
    x0[1]=0.0
    x0[2]=1.4
    ...
    elec = ec.HardCoreSin1D(rad,As,beta,num_cell,spring)
